...
const Navbar: FC = () => {
  ...
  const NavItems = () => {
    ...
    return (
      <>
        ...
        <NavItem url="/loops" name="Loops" current={pathname == '/loop'} />
        {/* <NavItem
          url="/explore"
          name="Explore"
  ...
  return (
    <Disclosure
      as="nav"
      className="sticky top-0 z-10 w-full bg-white border-b dark:bg-gray-900 dark:border-b-gray-700/80 h-16"
    >
      {({ open }) => (
        <>
                ...
                <Link href="/">
                  <a href="/">
                    <div className="text-3xl font-black">
                      <img className="w-32 h-32" src="/logo.svg" alt="Logo" />
                    </div>
                  </a>
                </Link>
