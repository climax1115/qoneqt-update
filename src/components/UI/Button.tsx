...
export const Button = forwardRef<HTMLButtonElement, Props>(function Button(
  ...
  return (
      ...
      className={clsx(
        {
          ...
          'bg-yellow-400 hover:bg-yellow-400 border border-yellow-400 text-white focus:ring-yellow-400':
            !outline && !light && variant === 'qoneqt',
          ...
          'border border-yellow-500 text-yellow-500 hover:bg-yellow-100 focus:ring-yellow-400':
            outline && !light && variant === 'warning',
          'border border-yellow-400 text-yellow-400 hover:bg-yellow-100 focus:ring-yellow-400':
            outline && !light && variant === 'qoneqt',
    ...
    >
      <div>{children}</div>
      <span className="w-2 h-2">{icon}</span>
    </button>
  )
})
