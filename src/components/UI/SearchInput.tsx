...
export const SearchInput = forwardRef<HTMLInputElement, Props>(function Input(
      ...
      <div className="flex">
        ...
        <input
          ...
          className={clsx(
            ...
            { 'rounded-r-xl': prefix },
            { 'rounded-xl': !prefix },
            'bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700/80 focus:border-hoverColor focus:ring-hoverColor disabled:opacity-60 disabled:bg-gray-500 disabled:bg-opacity-20 outline-none w-full',
            className
          )}
          type={type}
          ref={ref}
